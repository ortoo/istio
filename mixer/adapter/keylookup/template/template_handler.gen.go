...
const TemplateName = "keylookup"

// Instance is constructed by Mixer for the 'keylookup' template.
...
// process data associated with the 'keylookup' template.
//
...
type HandlerBuilder interface {
	...
	// SetKeylookupTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetKeylookupTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetKeylookupTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleKeylookup is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleKeylookup(context.Context, *Instance) (adapter.CheckResult, *Output, error)
}
